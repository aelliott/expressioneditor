 ...
 */
#include "pcreparser.hpp"

PcreParser::PcreParser(QString pattern, QObject *parent)
    : Parser(pattern, parent)
{
    ...
    _syntax.insert(std::pair<RegexpToken, QString>(T_FLAG_EXTENDED,
                   "x"));
    _syntax.insert(std::pair<RegexpToken, QString>(T_FLAG_PCRE_EXTRA,
                   "X"));
    _syntax.insert(std::pair<RegexpToken, QString>(T_FLAG_ANCHORED,
                   "A"));
    _syntax.insert(std::pair<RegexpToken, QString>(T_FLAG_UNGREEDY,
                   "U"));
}
